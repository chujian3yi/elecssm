...
/*     function findJctUnit(o){
    ...
    function checkUser(o){
    	...
    	$.post("${pageContext.request.contextPath }/elecUserController/checkUser",{"logonName":logonName},function(data){
    		if(data==1){
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			...
			<c:forEach items="${sexList}" var="sexList">
				<option value="${sexList.ddlcode}">${sexList.ddlname }</option>
			</c:forEach>
			</select>
		</td>
		...
		<td class="ta_01" bgColor="#ffffff">
	    	...
	    	<c:forEach items="${postList}" var="postList">
				<option value="${postList.ddlcode}">${postList.ddlname }</option>
			</c:forEach>
			</select>
		</td>
	</tr>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			...
			<c:forEach items="${isDutyList}" var="isDutyList">
				<option value="${isDutyList.ddlcode}">${isDutyList.ddlname }</option>
			</c:forEach>
			</select>
		</td>
	</tr>
