	...
	<HEAD>
		...
		function changetype(){
		  ...
		  if(document.Form1.keyword.value=="jerrynew"){
		     ...
		     Pub.submitActionWithForm('Form2','${pageContext.request.contextPath }/elecSystemDDLController/dictionaryEdit','Form1');
     ...
     function saveDict(){
	      ...
	      document.Form2.action="${pageContext.request.contextPath }/elecSystemDDLController/saveDictionaryEdit";
				...
				<tr>
					...
					<td class="ta_01" align="left"  width="30%" >
						...
						<select name="keyword" class="bg" style="width:180px" onchange="changetype()">
							...
							<option value=${systemList.keyword}>${systemList.keyword}</option>
