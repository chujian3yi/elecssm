...
<HTML>
	<HEAD>
       ...
       function selectRole(){
          if(document.Form1.roleId.value=="0"){
             ...
             document.Form1.action="${pageContext.request.contextPath}/elecRoleController/roleIndex";
             document.Form1.submit();            
          }else{
            Pub.submitActionWithForm('Form2','${pageContext.request.contextPath}/elecRoleController/roleEdit','Form1');
          }
       }
       /**
						...
						<td class="ta_01" align="left"  width="65%" >
						  	<select name="roleId" id="Form1_roleId" class="bg" style="width:180px" onchange="selectRole()">
							    ...
							    <c:forEach items="${roleList }" var="role">
							    	<option value='<c:out value="${role.roleId }"/>'>${role.roleName }</option>
							    </c:forEach>
							</select>
						</td>				
					</tr>
	...
	<form id="Form2" name="Form2" action="${pageContext.request.contextPath }/elecRoleController/roleIndex" method="post" style="margin:0px;">
